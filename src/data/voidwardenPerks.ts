...
export const VOIDWARDEN_PERKS: Array<{
  ...
  {
    label: 'Replace one −1 card with one +1 "Heal 1, Shield 1 ally" card',
    timesAvailable: 2,
    deckEffect: { remove: ['minus1'], add: ['heal-shield'] },
  },
  {
    label: 'Replace one +0 card with one +1 "Heal 1, Shield 1 ally" card',
    timesAvailable: 3,
    deckEffect: { remove: ['plus0'], add: ['heal-shield'] },
  },
  {
  ...
  {
    label: 'Replace one +0 card with one +1 Frost card',
    timesAvailable: 2,
    deckEffect: { remove: ['plus0'], add: ['frost1'] },
  },
